...
import maps from "../assets/images/maps@1920.png";
...
const Footer = ({ parrafof, parrafof2, btnf }) => {
  return (
    <div>
      ...
      <div
        className="flex items-center justify-between gap-[5rem] p-[9rem] max-[1700px]:px-[4rem] max-xl:px-[1rem]" 
        style={{
      ...
      >
        ...
        <div className="flex items-center gap-[20rem] max-[1800px]:gap-[10rem] max-[1500px]:gap-[5rem]">
          <div className="flex flex-col gap-[1.5rem] max-w-[400px]">
            ...
            <div>
              <button className="text-[1.8rem] font-moriston-semibold bg-slate-50 px-[6rem] py-[1rem] text-[#024b94]">
                {btnf}
              </button>
            </div>
          </div>
            ...
            <div className="flex gap-2">
              ...
              <div>
                ...
                <p className="text-[1.2rem] text-white font-moriston-personal-light max-w-[300px]">
                  Juan Carrasco, Col. Centro s/n Mazatlán, Sinaloa. Consultorio
                  305.
                </p>
              </div>
            </div>
