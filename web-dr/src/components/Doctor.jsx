...
const Doctor = () => {
  return (
    <div
      className="pt-[3rem] max-[426px]:py-[3rem]"
      data-aos="fade-up"
    ...
    >
      <div className="flex items-center gap-[15rem] justify-start max-[1800px]:gap-[8rem] max-[1600px]:gap-[4rem] max-xl:flex-wrap max-xl:justify-center">
        <img
          className="w-full max-w-[900px] max-[1600px]:max-w-[700px] max-[1400px]:max-w-[600px] max-xl:max-w-[800px] max-[800px]:max-w-[500px]"
          src={dr1}
          alt="dr-1.png"
        />
      ...
      <div className="flex items-center gap-[15rem] justify-end max-[1800px]:gap-[8rem] max-[1600px]:gap-[4rem] max-xl:flex-wrap-reverse max-xl:justify-center">
        ...
        <img
          className="w-full max-w-[900px] max-[1600px]:max-w-[700px] max-[1400px]:max-w-[600px] max-xl:max-w-[800px] max-[800px]:max-w-[500px] max-[426px]:pt-[3rem]"
          src={dr2}
          alt=" dr-2.png "
        />
      </div>
