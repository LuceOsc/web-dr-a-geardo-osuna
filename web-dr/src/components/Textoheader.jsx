...
const Textoheader = () => {
  return (
    <div className="font-moriston-personal-light flex flex-col items-center justify-center text-white gap-10  py-56 px-4 max-lg:py-32 max-[600px]:py-16" data-aos="fade-up" data-aos-duration="800"
    data-aos-offset="500"
    data-aos-easing="ease-in-sine">
      ...
      <h2 className=" text-[1.7rem] font-moriston-semibold max-lg:text-[1.4rem] max-[600px]:text-[1.1rem] max-[420px]:text-[1rem]">
        CLÍNICA DEL DOLOR
      </h2>
